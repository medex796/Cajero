...
public class Deposito2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, 140, 40));
        ...
        txtDeposito.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        txtDeposito.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtDepositoKeyTyped(evt);
            }
        });
        jPanel1.add(txtDeposito, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, 250, 30));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if (dolares ){
            if(verificarDolar()){//verificar si la cuenta esta en dolares
                ...
                Historia((Integer.parseInt(txtDeposito.getText()) *( 6.91))+"");
    ...
    private void txtDepositoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDepositoKeyTyped
     ...
     public void Historia(String monto){
        LocalDateTime ahora = LocalDateTime.now();
                       ...
                       Historia historia = new Historia (fechaYHoraActual,"Deposito",monto,null,000000);
