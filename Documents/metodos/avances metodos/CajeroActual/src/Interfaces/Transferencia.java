...
public class Transferencia extends javax.swing.JFrame {
 ...
 private void actualizarLista() {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 150, 40));

        txtSaldoTransferir.setBackground(new java.awt.Color(34, 32, 52));
        ...
        jButton7.setBackground(new java.awt.Color(34, 32, 52));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 480, 130, 30));

        txtCuentaTransferir.setBackground(new java.awt.Color(34, 32, 52));
        ...
        jPanel1.add(txtCuentaTransferir, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 480, 40));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, 270, 40));

        jButton8.setBackground(new java.awt.Color(34, 32, 52));
        ...
        jPanel1.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 480, 110, -1));
         ...
         if(!txtCuentaTransferir.getText().equals("")&&!txtSaldoTransferir.getText().equals("")){
            ...
            if (cuentaExiste(Integer.parseInt(txtCuentaTransferir.getText()))){
                if(saldo(numeroCuenta) >= (Double.parseDouble(txtSaldoTransferir.getText()))){
                    ...
                    Historia historiaEmisor = new Historia (LocalDateTime.now().toLocalDate().toString(),"Transaccion","-"+( txtSaldoTransferir.getText()),nombreCliente(Integer.parseInt(txtCuentaTransferir.getText())),Integer.parseInt(txtCuentaTransferir.getText()));
                    Historia historiaReceptor = new Historia (LocalDateTime.now().toLocalDate().toString(),"Transaccion","+"+txtSaldoTransferir.getText(),nombreCliente(numeroCuenta),numeroCuenta);
                    agregarHistoria(historiaEmisor,historiaReceptor,Integer.parseInt(txtCuentaTransferir.getText()));
                                                                                 JOptionPane.showMessageDialog(null, "Saldo infffffffsuficiente  ", "Error", JOptionPane.INFORMATION_MESSAGE);
